...
const HelpfulLinks = () => (
  ...
  <Row className="Links">
      <div className="link">
        <h4>HSE</h4>
        <a target="_blank" href="https://www2.hse.ie/conditions/coronavirus/coronavirus.html">
      ...
      <div className="link">
        <h4>CDC</h4>
        <a target="_blank" href="https://www.cdc.gov/coronavirus/2019-ncov/faq.html">
      ...
      <div className="link">
        ...
        <a target="_blank" href="https://coronavirus.thebaselab.com/">
